...
export class TCPClient extends EventEmitter {
    ...
    constructor(private myIdentity: Identity, private peerIp: string, private peerPort: number) {
        super();
        ...
        return new Promise((resolve, reject) => {
            this.socket.connect(this.peerPort, this.peerIp, async () => {
                try {
                    ...
                    const { ephemeralKeyPair, packet } = await Handshake.initiate(this.myIdentity);
